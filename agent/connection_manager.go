...
// It handles WebSocket connections outbound to the hub.
...
func (c *ConnectionManager) Start(opts AgentOptions) error {
	if c.eventChan != nil {
...
// connect handles the connection logic
...
// shouldExitOnErr checks if the error is a DNS resolution failure
